 ...
 * [1450] 在既定时间做作业的学生人数
 *
 * https://leetcode-cn.com/problems/number-of-students-doing-homework-at-a-given-time/description/
 *
 * algorithms
 * Easy (80.37%)
 * Likes:    29
...
int main() {
    ...
    cout << Solution().busyStudent(startTime, endTime, 4) << endl;
    return 0;
}